...
class Header extends React.Component {
    constructor(props) {
        ...
        console.log(typeof this.props.setMenuOpen)
    }
    async LoadObjects () {
        var data =  await GetData(API_LINK+"/objects",{"sort":"new"},"post")
        var new_objects = {
            commercial:[],
            residential:[],
        }
        for (var i = 0; i < data.length; i++) {
            var type = ""
            if(data[i].type === 0) type = "commercial"
            else if(data[i].type === 1) type = "residential"
            new_objects[type].push({
                id:data[i].id,
                name:data[i].name,
            })
        }
    ...
    componentDidMount() {
        if(!this.state.objects) this.LoadObjects()
    }
    render() {
        if(this.props.scrollDirection !== this.state.scrollDirection) {
            this.setState({
                scrollDirection: this.props.scrollDirection
            })
        }
        if(this.props.menuOpen !== this.state.menuOpen) {
            this.state.setMenuOpen(this.props.menuOpen)
        }
        return (
            <div
                className={isMobile() ? ( this.state.menuOpen ? "header" : "header header-scroll-"+this.state.scrollDirection) + (this.state.menuOpen ? "" : " header-fixed") : "header"}
                onClick={()=>{
                    console.log(typeof this.state.setMenuOpen)
                    this.state.setMenuOpen(true)
                }}
            >
                <div className="menu-screen" style={{display: this.state.menuOpen ? "block" : "none"}} onScroll={(e) => e.stopPropagation()}>
                    <div className="top">
                        <div className="logo" onClick={ () => window.location.href = "/"}>
                            <img src={"/company-logo.svg"} alt="" height={"40px"} width={"40px"}/>
                        </div>
                        <div className="close-btn" onClick={ () => this.state.setMenuOpen(false)}>
                    ...
                    <div className="middle">
                        <div className="links">
                            ...
                            <div className="line" onClick={ () => {
                                console.log("clicked")
                                var new_menuFolding = this.state.menuFolding
                                new_menuFolding.objects.flag = !new_menuFolding.objects.flag
                                this.setState({menuFolding: new_menuFolding})
                            }}>
                                <div className="line-content">
                                    <div className="line-header">
                                        <div className="text">
                                            <a href={link_Objects}>Объекты</a>
                                        </div>
                                        <div className="fold-icon" >
                                            <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0.5 0.5L5 5L9.5 0.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                            </svg>
                                        </div>
                                    </div>
                                    <div className="menu" style={{
                                        display: this.state.menuFolding.objects.flag ? "block" : "none",
                                    }}>
                                        <div className="line">
                                            <div className="line-content">
                                                <div className="line-header">
                                                ...
                                                <div className="menu">
                                                    {
                                                        this.state.objects ? this.state.objects.commercial.map((item, index) => {
                                                            return (
                                                                <div className="line">
                                                                    <div className="line-content">
                                                                        <div className="line-header">
                                                                            <div className="text">
                                                                                <a href={link_Objects + "/commercial/" + item.id}>{item.name}</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div className="line">
                                            <div className="line-content">
                                                ...
                                                <div className="menu">
                                                    {
                                                        this.state.objects ? this.state.objects.residential.map((item, index) => {
                                                            return (
                                                                <div className="line">
                                                                    <div className="line-content">
                                                                        <div className="line-header">
                ...
                <div className="menu-icon" onClick={() => this.setMenuOpen(!this.state.menuOpen)}>
...
const Header = ({menuOpen, setMenuOpen,scrollDirection}) => {
    ...
    const [menuFolding, setMenuFolding] = useState({
        objects: {
            flag: false,
            commercial: {
                flag: false,
                        ...
                        <div className="line">
                            <div className="line-content">
                                <div className="line-header">
                                    ...
                                    <div className="fold-icon" onClick={ () => {
                                        var new_menuFolding = menuFolding
                                        new_menuFolding.objects.flag = !new_menuFolding.objects.flag
                                        setMenuFolding(new_menuFolding)
                                        setReload(!reload)
                                    }}
                                    >
                                        <svg width="16" height="16" viewBox="0 0 10 5" fill="none" xmlns="http://www.w3.org/2000/svg" style={{rotate: menuFolding.objects.flag ? "0deg" : "180deg"}}>
                                            <path d="M0.5 0.5L5 5L9.5 0.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </div>
                                </div>
                                <div className="menu" style={{
                                    display: menuFolding.objects.flag ? "block" : "none",
                                    marginLeft: "10px",
                                }}>
                                    <div className="line">
                                        <div className="line-content">
                                            <div className="line-header">
                                                ...
                                                <div className="fold-icon"
                                                     onClick={ () => {
                                                         var new_menuFolding = menuFolding
                                                         new_menuFolding.objects.commercial.flag = !new_menuFolding.objects.commercial.flag
                                                         setMenuFolding(new_menuFolding)
                                                         setReload(!reload)
                                                     }}
                                                >
                                                <svg width="16" height="16" viewBox="0 0 10 5" fill="none" xmlns="http://www.w3.org/2000/svg" style={{rotate: menuFolding.objects.commercial.flag ? "0deg" : "180deg"}}>
                                                    <path d="M0.5 0.5L5 5L9.5 0.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                </svg>
                                                </div>
                                            ...
                                            <div className="menu" style={{
                                                display: menuFolding.objects.commercial.flag ? "block" : "none",
                                                marginLeft: "10px",
                                            }}>
                                                {
                                                    objects ? objects.commercial.map((item, index) => {
                                                        return (
                                                            <div className="line">
                                                                <div className="line-content">
                                                                    <div className="line-header">
                                                                        <div className="text">
                                                                            <a href={link_Object + item.id}>{item.name}</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div className="line-content">
                                            <div className="line-header">
                                                ...
                                                <div className="fold-icon"
                                                     onClick={ () => {
                                                         var new_menuFolding = menuFolding
                                                         new_menuFolding.objects.residential.flag = !new_menuFolding.objects.residential.flag
                                                         setMenuFolding(new_menuFolding)
                                                         setReload(!reload)
                                                     }}
                                                >
                                                    <svg width="16" height="16" viewBox="0 0 10 5" fill="none" xmlns="http://www.w3.org/2000/svg" style={{rotate: menuFolding.objects.residential.flag ? "0deg" : "180deg"}}>
                                                        <path d="M0.5 0.5L5 5L9.5 0.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                    </svg>
                                                </div>
                                            </div>
                                            <div className="menu" style={{
                                                display: menuFolding.objects.residential.flag ? "block" : "none",
                                                marginLeft: "10px",
                                            }}>
                                                {
                                                    objects ? objects.residential.map((item, index) => {
                                                        return (
                                                            <div className="line">
                                                                <div className="line-content">
                                                                    <div className="line-header">
